...
// Copyright (c) 2017-2017 The WCXCOIN developers
...
#if defined(NDEBUG)
#error "WCXCOIN cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uwcx) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // WCX: We use certain sporks during IBD, so check to see if they are
